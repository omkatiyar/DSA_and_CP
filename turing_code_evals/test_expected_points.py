...
class TestExpectedPoints(unittest.TestCase):
    ...
    def setUpClass(cls):
        try:
            ...
            cpp_file_path = "model_expected_points.cpp"
    ...
    def test_skewed_case(self):
        S = cppyy.gbl.std.vector[int]([1, 2, 3, 6])
        P = cppyy.gbl.std.vector[int]([50, 50, 50, 70])
        result = cppyy.gbl.calculateExpectedValue(4, S, P)
        expected_value = "3/2"
        self.assertEqual(result,expected_value)
